...
ARG SEARXNG_INSTANCE_URL="http://192.168.0.100:8089"
ARG SEARXNG_USERNAME=""
ARG SEARXNG_PASSWORD=""
...
RUN apt-get update \
   ...
   && curl -LsSf https://astral.sh/uv/install.sh | sh \
    && uv pip install --system --upgrade --verbose --no-cache --break-system-packages --prerelease=allow searxng-mcp[all]>=0.1.28
